...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                .requestMatchers(HttpMethod.OPTIONS, "/api/member/signup", "/api/member/check").permitAll() // Permit OPTIONS requests
                .requestMatchers("/api/member/signup", "/api/member/check").permitAll() // Allow unauthenticated access
