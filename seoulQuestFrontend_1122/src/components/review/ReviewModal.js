...
import { deleteOne,putOne } from "../../api/reviewApi" 
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="relative bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
         {selectedReview.email === loginState.email && (
                <div className="absolute top-8 right-10 px-3 py-1 text-sm font-semibold text-white bg-teal-500 rounded-lg shadow-md">
                  My Review
                </div>
              )}
        {!isEditMode ? (
              ...
              {selectedReview.email === loginState.email && (
                <>
                  ...
                  <button
                    ...
                    onClick={() => handleClickDelete(selectedReview.prid)}
                  >
                    Delete
                  </button>
                </>
