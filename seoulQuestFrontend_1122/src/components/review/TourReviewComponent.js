...
//                     ))
//                 ) : (
//                     <div className="text-center text-gray-500 py-10">There is no review available.</div>
//                 )}
//                 <div className="mt-8">
//                     <PageComponent serverData={serverData} movePage={movePage} />
//                 </div>
//             </div>
//             {editModalOpen && <ReviewModal selectedReview={selectedReview} closeModal={closeEditModal} />}
//             {addModalOpen && <ReviewAddModal refresh={refresh} closeModal={closeAddModal} />}
//         </div>
