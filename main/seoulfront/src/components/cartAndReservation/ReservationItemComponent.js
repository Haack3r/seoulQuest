...
const ReservationItemComponent = ({ rino, tname, tprice, tdate, tno, tqty, pfiles, changeReservation, email, maxCapacity, availableCapacity }) => {
        ...
        <div key={rino} className="bg-white shadow-md rounded-lg p-5 mb-5 transition duration-300 hover:shadow-xl">
            ...
            <div className="flex items-start space-x-4 mb-4">
                <div className="overflow-hidden rounded-md shadow-sm flex-1">
                    <img className="w-full h-20 object-cover rounded-md" src={`${host}/api/tours/view/${pfiles}`} alt={tname} />
                </div>
                ...
                <div className="flex items-center justify-between bg-gray-50 border border-gray-300 rounded-md p-2 mb-4">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button
                            ...
                            className={`px-3 py-1 rounded-md ${tqty >= maxCapacity ? "bg-gray-300 text-gray-400" : "text-gray-700 bg-gray-200 hover:bg-gray-300"
                                }`}
                        >
                            +
                        </button>
