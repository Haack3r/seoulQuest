            ...
            <div className="flex-1 p-8">
                ...
                <div className="grid xl:grid-cols-3 lg:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white p-6 rounded-xl">
                        <div className="flex justify-between items-center">  {/* items-start를 items-center로 변경 */}
                            <div>
            ...
            < div className="hidden lg:block w-80 bg-white p-6 border-l">
                <div className="mb-8">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button className="bg-blue-600 text-white px-3 py-1 rounded-lg text-sm">+ 추가</button>
                    </div>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        {[
                            { color: 'bg-blue-100', time: '18:30', text: '한강 야경 투어 예약 10건 대기 중' },
                            { color: 'bg-yellow-100', time: '17:30', text: '인기 상품 "명동 기념품 세트" 재고 부족 (5개 남음)' },
                            { color: 'bg-red-100', time: '17:00', text: '고객 문의 3건이 답변 대기 중입니다.' },
                            { color: 'bg-green-100', time: '16:45', text: '새로운 상품 등록이 완료되었습니다.' },
                        ].map((item, i) => (
