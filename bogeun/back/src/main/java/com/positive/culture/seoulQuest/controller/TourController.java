...
public class TourController {
    ...
    // return tours.stream()
    // .map(tour -> new TourMapDTO(tour.getTname(), tour.getTaddress())) // Ensure
    // taddress has full address
    ...
    // 업로드된 파일 보여주기 (유저, 관리자)
    // http://localhost:8080/api/products/view/파일명.파일형식 (upload폴더에 존재하는 파일)으로 접속하여
    // test-성공
