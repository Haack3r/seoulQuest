...
import { getProductsByCategoryNU } from './../../../api/nuProductApi';
...
const ProductCategoryTea = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        const response = await getProductsByCategoryNU({
          page: 1,
          size: 100, // Fetch a large number for local pagination
          category,
        });
      ...
      <div className="w-full lg:w-1/2 relative">
        <div className="mb-10 relative">
          ...
          <div className="px-10 mb-4 text-center">
            <h2 className="text-lg font-bold text-gray-800 uppercase">{category} Collection</h2>
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative w-48 h-60 overflow-hidden z-10"
                         onClick={() => {
                          {loginState.email ? moveToProductRead(product.pno) : moveToProductReadNU(product.pno)}
