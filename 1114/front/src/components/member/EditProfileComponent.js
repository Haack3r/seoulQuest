                ...
                <div className="flex gap-6 items-center">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex space-x-2">
                            ...
                            <Button
                                type="button"
                                className="w-1/3 p-3 md:w-1/5 bg-gray-400 text-white font-bold rounded-lg duration-300 transform hover:-translate-y-1"
                    ...
                    <div className="flex space-x-4 mt-20">
                        <Button
                            type="submit"
                            className="w-full py-3 bg-gray-400 text-white font-bold rounded-lg duration-300 transform hover:-translate-y-1"
                        ...
                        <Button
                            type="button"
                            className="w-full py-3 bg-stone-400 text-white font-bold rounded-lg duration-300 transform hover:-translate-y-1"
