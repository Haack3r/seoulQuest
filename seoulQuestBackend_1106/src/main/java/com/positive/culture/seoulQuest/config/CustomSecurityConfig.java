...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/member/signup", "/api/member/check", "/api/member/checknickname", "/api/member/login","/api/mypage/**","/api/user/tours/view/**","/api/user/products/view/**").permitAll()
